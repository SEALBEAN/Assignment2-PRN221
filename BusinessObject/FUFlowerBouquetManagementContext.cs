...
namespace BusinessObject
{
    public partial class FUFlowerBouquetManagementContext : DbContext
    {
        ...
        private string GetConnectionString()
        {
            ...
            var strConn = config["ConnectionStrings:FUFlowerBouquetManagement"];
            return strConn;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FlowerBouquet>(entity =>
            {
                ...
                entity.HasOne(d => d.Category)
                    ...
                    .HasConstraintName("FK__FlowerBou__Categ__403A8C7D");

                entity.HasOne(d => d.Supplier)
                    .WithMany(p => p.FlowerBouquets)
                    .HasForeignKey(d => d.SupplierId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__FlowerBou__Suppl__412EB0B6");
            });
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.FlowerBouquetId })
                    .HasName("PK__OrderDet__C983CA9FF815BD90");
                ...
                entity.HasOne(d => d.FlowerBouquet)
                    ...
                    .HasConstraintName("FK__OrderDeta__Flowe__4316F928");
